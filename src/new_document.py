...
class Ui_NewDocumentDialog(object):
    def setupUi(self, NewDocumentDialog):
        ...
        NewDocumentDialog.resize(400, 250)
        NewDocumentDialog.setMinimumSize(QtCore.QSize(400, 250))
        NewDocumentDialog.setMaximumSize(QtCore.QSize(400, 250))
        icon = QtGui.QIcon()
        ...
        self.time_signatures = QtWidgets.QGroupBox(NewDocumentDialog)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.time_signatures.sizePolicy().hasHeightForWidth())
        self.time_signatures.setSizePolicy(sizePolicy)
        self.time_signatures.setObjectName("time_signatures")
        self.horizontalLayout_3 = QtWidgets.QHBoxLayout(self.time_signatures)
        self.horizontalLayout_3.setContentsMargins(3, 3, 3, 3)
        self.horizontalLayout_3.setObjectName("horizontalLayout_3")
        self.time_signature_spin_box_labels = QtWidgets.QVBoxLayout()
        self.time_signature_spin_box_labels.setObjectName("time_signature_spin_box_labels")
        self.fundamental_beats_label = QtWidgets.QLabel(self.time_signatures)
        self.fundamental_beats_label.setObjectName("fundamental_beats_label")
        self.time_signature_spin_box_labels.addWidget(self.fundamental_beats_label)
        self.note_value_label = QtWidgets.QLabel(self.time_signatures)
        self.note_value_label.setObjectName("note_value_label")
        self.time_signature_spin_box_labels.addWidget(self.note_value_label)
        self.horizontalLayout_3.addLayout(self.time_signature_spin_box_labels)
        self.verticalLayout_4 = QtWidgets.QVBoxLayout()
        self.verticalLayout_4.setObjectName("verticalLayout_4")
        self.fundamental_beats_spin_box = QtWidgets.QSpinBox(self.time_signatures)
        ...
        self.verticalLayout_4.addWidget(self.fundamental_beats_spin_box)
        self.note_value_combo_box = QtWidgets.QComboBox(self.time_signatures)
        self.note_value_combo_box.setDuplicatesEnabled(False)
        self.note_value_combo_box.setFrame(True)
        self.note_value_combo_box.setObjectName("note_value_combo_box")
        self.note_value_combo_box.addItem("")
        self.note_value_combo_box.addItem("")
        self.note_value_combo_box.addItem("")
        self.verticalLayout_4.addWidget(self.note_value_combo_box)
        self.horizontalLayout_3.addLayout(self.verticalLayout_4)
        self.specific_settings_layout.addWidget(self.time_signatures)
        self.other_settings_layout = QtWidgets.QHBoxLayout()
        self.other_settings_layout.setObjectName("other_settings_layout")
        self.other_settings_labels = QtWidgets.QVBoxLayout()
        self.other_settings_labels.setObjectName("other_settings_labels")
        self.key_signature_label = QtWidgets.QLabel(NewDocumentDialog)
        self.key_signature_label.setObjectName("key_signature_label")
        self.other_settings_labels.addWidget(self.key_signature_label)
        self.staffs_label = QtWidgets.QLabel(NewDocumentDialog)
        self.staffs_label.setObjectName("staffs_label")
        self.other_settings_labels.addWidget(self.staffs_label)
        self.other_settings_layout.addLayout(self.other_settings_labels)
        self.other_settings = QtWidgets.QVBoxLayout()
        self.other_settings.setObjectName("other_settings")
        self.horizontalLayout = QtWidgets.QHBoxLayout()
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.key_signatures_combo_box = QtWidgets.QComboBox(NewDocumentDialog)
        ...
        self.key_signatures_combo_box.addItem("")
        self.key_signatures_combo_box.addItem("")
        self.horizontalLayout.addWidget(self.key_signatures_combo_box)
        self.other_settings.addLayout(self.horizontalLayout)
        self.staffs_spin_box = QtWidgets.QSpinBox(NewDocumentDialog)
        self.staffs_spin_box.setFrame(True)
        self.staffs_spin_box.setMinimum(1)
        self.staffs_spin_box.setMaximum(4)
        self.staffs_spin_box.setProperty("value", 2)
        self.staffs_spin_box.setObjectName("staffs_spin_box")
        self.other_settings.addWidget(self.staffs_spin_box)
        self.other_settings_layout.addLayout(self.other_settings)
        self.specific_settings_layout.addLayout(self.other_settings_layout)
    ...
    def retranslateUi(self, NewDocumentDialog):
        ...
        self.time_signatures.setTitle(_translate("NewDocumentDialog", "Takttart"))
        self.fundamental_beats_label.setText(_translate("NewDocumentDialog", "Schläge"))
        self.note_value_label.setText(_translate("NewDocumentDialog", "Notenwert"))
        self.note_value_combo_box.setCurrentText(_translate("NewDocumentDialog", "4"))
        self.note_value_combo_box.setItemText(0, _translate("NewDocumentDialog", "2"))
        self.note_value_combo_box.setItemText(1, _translate("NewDocumentDialog", "4"))
        self.note_value_combo_box.setItemText(2, _translate("NewDocumentDialog", "8"))
        self.key_signature_label.setText(_translate("NewDocumentDialog", "Vorzeichen"))
        self.staffs_label.setText(_translate("NewDocumentDialog", "Notenliniensysteme"))
