...
class Ui_NewDocumentDialog(object):
    def setupUi(self, NewDocumentDialog):
        ...
        self.staves_spin_box = QtWidgets.QSpinBox(NewDocumentDialog)
        ...
        self.other_settings.addWidget(self.staves_spin_box)
    ...
    def retranslateUi(self, NewDocumentDialog):
        ...
        self.key_signature_label.setText(_translate("NewDocumentDialog", "Tonart"))
        self.staffs_label.setText(_translate("NewDocumentDialog", "Stimmen pro System"))
